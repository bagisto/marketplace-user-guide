...
- **Commission** — `commission_enabled` and `commission_percentage` set a seller's [commission](/commission-management).
- **Magic AI** — `magic_ai_enabled` and `magic_ai_seller_limit` govern a seller's [Magic AI](/magic-ai) access and quota.
