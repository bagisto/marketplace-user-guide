...
Expand a row to see its stock **per inventory source** (a seller with more than one warehouse or store manages each separately — see [Inventory Sources](/inventory-source-management)). Enter the new quantity and save.

::: tip
Select several rows to update their status in bulk. Keeping stock accurate directly protects your [account health](/seller-account-health) — overselling and cancellations pull the score down.
:::
